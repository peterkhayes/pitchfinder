...
module.exports = function (detector, float64AudioBuffer, options = {}) {
  ...
  for (let i = 0, max = bufferLength - chunkSize; i <= max; i += chunkSize) {
    const chunk = float64AudioBuffer.slice(i, i + chunkSize)
